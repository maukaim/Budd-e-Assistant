...
import com.maukaim.budde.assistant.intellij.plugin.ui.tool_window.panels.assistant.toolbar.actions.popup.FileTeachingPopupManager;
...
public class UpdateTrackedFoldersAction extends AssistantDependentAction {
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        FileTeachingPopupManager.createAndShow(ctx);
    }
}
