...
public class CloseActionButton  extends IconButton implements ActionListener {
    ...
    public CloseActionButton(TabInfo tabInfo,
                      AnAction action,
                      String place, Consumer<MouseEvent> pass, Consumer<Boolean> hover, TimedDeadzone.Length deadzone) {
